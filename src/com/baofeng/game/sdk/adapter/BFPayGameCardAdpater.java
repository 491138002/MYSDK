...
public class BFPayGameCardAdpater extends BaseAdapter{

	private LayoutInflater mInflater;
	private Context context;
	private int selectIndex;
	private int[] rIds = {
			BFResources.drawable.bx_btn_jw_selector, BFResources.drawable.bx_btn_qq_selector,
			BFResources.drawable.bx_btn_sd_selector, BFResources.drawable.bx_btn_wm_selector,
			BFResources.drawable.bx_btn_wy_selector
			
	};
	
	public BFPayGameCardAdpater(Context context){
			...
			public void onClick(View arg0) {
				...
				case 0:
					if(context instanceof BFPayActivity){
						((BFPayActivity)context).setJunWangTipList();
					}
					break;
				case 1:
					if(context instanceof BFPayActivity){
				...
				case 2:
					if(context instanceof BFPayActivity){
						((BFPayActivity)context).setShengDaTipList();
					}
					break;
				case 3:
					if(context instanceof BFPayActivity){
						((BFPayActivity)context).setWanMeiTipList();
					}
					break;
				case 4:
					if(context instanceof BFPayActivity){
						((BFPayActivity)context).setWangYiTipList();
					}
					break;
				}
